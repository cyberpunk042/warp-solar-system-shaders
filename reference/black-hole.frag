// Self-contained black hole with gravitational lensing + accretion disk.
// iChannel0 = a nebula texture (the Warp port replaces it with procedural
// value-noise fBm; see warp_shaders/scenes/black_hole.py). iMouse = camera.
